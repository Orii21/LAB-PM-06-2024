...
public class Instagram implements Parcelable {
    ...
    public Instagram(String username, String desc, int fotoProfile, int fotoPostingan) {
    ...
    public Instagram(String username, String konten, int fotoProfile, Uri selectedImageUri) {
        this.username = username;
        this.desc = konten;
        this.fotoProfile = fotoProfile;
        this.selectedImageUri = selectedImageUri;
    }
    public Instagram(String username, int fotoProfile) {
        this.username = username;
        this.fotoProfile = fotoProfile;
    }
